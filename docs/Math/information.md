...
!!! note "Acknowledgement"
    - [关于 KL 散度（Kullback-Leibler Divergence）的笔记 - 捡到一束光 - 知乎](https://zhuanlan.zhihu.com/p/438129018)
...
˜
!!! note "Acknowledgement"
    - 这篇非常形象👍[一篇文章讲清楚交叉熵和 KL 散度 - 一丁点 - 知乎](https://zhuanlan.zhihu.com/p/573385147)
    ...
    - [交叉熵损失函数（cross-entropy loss function）原理及 Pytorch 代码简介-CSDN 博客](https://blog.csdn.net/chao_shine/article/details/89925762)
