...
![image](https://philfan-pic.oss-cn-beijing.aliyuncs.com/web_pic/Robotics_______assets____.assets__7c0ca0cd5a0abd5d8d0afe88f596aba6.webp)

![image](https://philfan-pic.oss-cn-beijing.aliyuncs.com/web_pic/Robotics_______assets____.assets__20250322171345.webp)
...
![image](https://philfan-pic.oss-cn-beijing.aliyuncs.com/web_pic/Robotics_______assets____.assets__20250220101016245.webp)
...
1. **发送超声波信号**：当有脉冲电压触发时（就是控制板给 Trig 引脚发送高电频），探头里的晶片就会振动，这会产生一个超声波信号（通常是 40kHz 的声波）。**(逆压电效应)**
...
4. **计算距离**：利用声音在空气中的传播速度，可以根据回波时间计算距离。声速在空气中的速度约为 343 米/秒，或者 **0.0343 cm/μs**。因为超声波是来回传播的，所以下来的总时间需要除以 2 来得到物体的单程距离。
...
![image](https://philfan-pic.oss-cn-beijing.aliyuncs.com/web_pic/Robotics_______assets____.assets__20250221145610972.webp)
...
```cpp
#define TRIG_PIN 2   // 设置 Trig 引脚为 2，可以自定义
#define ECHO_PIN 3  // 设置 Echo 引脚为 3，可以自定义
...
- 在温度上的测量范围是 0-50 摄氏度，在湿度上的测量范围是 20-90%
![image](https://philfan-pic.oss-cn-beijing.aliyuncs.com/web_pic/Robotics_______assets____.assets__20250220101159848.webp)
