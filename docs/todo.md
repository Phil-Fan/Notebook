...
!!! tip "短期想要做的"
    - [ ] dRehmFlight
    - [ ] 做一个 diffusion 相关的开源项目：build with bombs
    - [ ] 把智能家居魔杖丰富一下
    - [ ] tsp
    - [x] 学习一下 limu 怎么引用论文，把这个[Semantic Scholar - Academic Graph API](https://api.semanticscholar.org/api-docs/graph)搞到文档里面

!!! tip "课外目标"
    📚 阅读《倾城之恋》<br>
    💪 健身目标：

        - 体重降到 65kg 左右，体脂率降到 15% 左右<br>
        - 引体>10（✅完成）
        - 卧推 60kg
        - 深蹲 100kg（没达到 qwq）<br>
